...
tomsadventure.DemoMode = function (lcdgame) {
  ...
  this.demotimer = null;
  this.democount = 0;
  this.demostate = 0; // 0=demo, 1=g1, 2=g2
};
tomsadventure.DemoMode.prototype = {
  ...
  press: function (btn) {
    ...
    if (this.demostate !== 0) {
      // toggle sound on/off
      if (btn === 'melody') {
        const snd = !this.lcdgame.soundmute;
...
tomsadventure.MainGame.prototype = {
  ...
  continueGame: function () {
    ...
    // show "G1" or "G2"
    const gametxt = (this.lcdgame.gametype === 1 ? 'game_1' : 'game_2');
  ...
  moveDragonRock: function () {
    ...
    const str = (this.dragidx % 2 ? 'rock' : 'dragon');
  ...
  onTimerGame: function () {
    ...
    const t = this.gametimer.counter - 1;
